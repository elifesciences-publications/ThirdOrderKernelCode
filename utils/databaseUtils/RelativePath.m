...
% Convert to all lowercase: (Except actually rewrite them as they're supposed to be, uppercase, doy?)
tgt_path_orig = tgt_path;
...
tgt_path_cell_orig = pathparts(tgt_path_orig);
...
for  i = 1 : length(tgt_path_cell)
   rel_path = [rel_path tgt_path_cell_orig{i} filesep];
end
