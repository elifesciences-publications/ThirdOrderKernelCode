function Generate_VisualStim_And_VelEstimation_WithinScene...
...
switch velocity.distribution
    ...
    case 'binary'
        ...
        [~, col_pos_sequence] = Generate_VisStimVelEst_Utils_WithinScene_GenVel(n_total_image,  velocity, 'seed_num', seed_num);
...
v2_different_types = zeros(space_range - 1, n_vel, n_total_image, length(synthetic_type_bank));
if strcmp(kernel_extraction_method, 'reverse_correlation')
    v3_different_types = zeros(space_range - 1, n_vel, n_total_image, length(synthetic_type_bank));
end
sample_counter = 1;
