function [time_series_scale_back_upsample_used,time_series_scale_back_used]  = MaxEntDist_AllMar_TwoCov_Utils_GibbsSampling_OneScene(x_solved_scale, gray_value_mean_subtracted_scale, gray_value, N, K, resolution_n_pixel, varargin)
n_hor = 927;
n_times= 1;
n_sample = 10000;
plot_flag = false;
