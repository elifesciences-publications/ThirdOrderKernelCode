function [texStr,stimData] = CLSineWaveAnyHzScramble(Q)
...
if f == 1
    ...
    if ~isfield(stimData,'sinScramOrderL')
        stimData.sinScramOrderL = randperm(sizeX);
    end
    
    if ~isfield(stimData,'sinScramOrderR')
...
bitMap = 255*mlumL*(1 + bitMap + wnCL*sinScramWNL);
