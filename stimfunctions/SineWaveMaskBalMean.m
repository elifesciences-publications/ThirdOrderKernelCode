function [texStr,stimData] = SineWaveMaskBalMean(Q)
...
%     end
    ...
    for cc = 1:framesPerUp
        ...
        setPi = cL*sin(2*pi*(theta(1:length(gridUnit))-stimData.sinPVL(1))/lambdaL+pi);
    ...
    if p.twoEyes
        ...
        for cc = 1:framesPerUp
            ...
            setPi = cR*sin(2*pi*(theta(1:length(gridUnit))-stimData.sinPVR(1))/lambdaR+pi);
