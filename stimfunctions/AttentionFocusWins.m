function [texStr,stimData] = AttentionFocusWins(Q)
...
stimData.mat(2) = sum(~overlapMap(:)); % to make sure there are the same number of focus and shadow dots in different epochs
