function [texStr,stimData] = SnakeStatic_randomPhase(Q)
...
stimData.mat(9)= val > stimData.mat(8);
stimData.mat(8) = val ;
...
if stimData.mat(9)
    stimData.mat(7)=floor(rand*(size(pat,2)));
end
...
bitMap(:,:,1:3)=repmat((ind'*a2(:,:))+(ind2'*c(:,:)),[1,1,3]);
