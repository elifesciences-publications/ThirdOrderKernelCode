function [timeByRoisOut,roiMaskOut] = RoiSelectionSizeAndResp(timeByRois,roiMask,epochStartTimes,epochDurations,epochsForSelectivity,params,interleaveEpoch,varargin)
    sizeMin = 6;
    sizeMax = inf;
    ...
    for ex = 1:numRoiExtractions;
        ...
        for ss = 1:numEpochComparisons
            ...
            roisSelectedByEpochResponse(ss,:) = SelectRoisByEpochResponse(timeByRois,roiMask,epochStartTimes,epochDurations,epochsForSelectivity(ex,2*ss-1:2*ss),params,epochRespPercentThreshold);
        end
