...
% If an epoch code is too short, it's gonna get skipped and a zero is gonna
% land as its 'epoch_number'. Just get rid of those here. Get rid of the
% boundary_inds first so that there are still zeros in epoch_number >.>
epoch_boundary_inds(epoch_number==0, :) = [];
