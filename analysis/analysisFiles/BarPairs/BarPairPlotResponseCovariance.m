function covarFig = BarPairPlotResponseCovariance(responseCorrelations, barToCenter, numPhases, optimalResponseField, plotAllCovariances)
...
if plotAllCovariances < 2
    ...
    for i = 1:length(optimalPhases)
        ...
        plotY = max(corrOfInt)+0.25;
        PlotXvsY(dataX, corrOfInt', 'graphType', 'bar' )
        axVals = axis;
        minY = [minY axVals(3)];
        maxY = plotY;
