 function analysis = CombAndSepFFT(flyResp,epochs,params,stim,dataRate,dataType,interleaveEpoch,varargin)
...
%         averagedTime = ReduceDimension(combinedOpposites, 'time');
        ...
        % get the fft amplitude for 1 Hz
        averagedTime = ReduceDimensionFFT(combinedOpposites);
