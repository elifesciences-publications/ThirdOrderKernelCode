function [timeByRoisOut,roiMaskOut, selectedRois] = RoiSelectionSizeAndResp_v2(timeByRois,roiMask,epochStartTimes,epochDurations,epochsForSelectivity,params,interleaveEpoch,varargin)
    sizeMin = 6;
    sizeMax = inf;
    epochRespPercentThreshold = 0.5;
    ...
    for ex = 1:numRoiExtractions;
        ...
        for ss = 1:numEpochComparisons
            ...
            roisSelectedByEpochResponse(ss,:) = SelectRoisByEpochResponse_v2(timeByRois,roiMask,epochStartTimes,epochDurations,epochsForSelectivity(ex,2*ss-1:2*ss),params,epochRespPercentThreshold);
        end
