function D = RespHeat(varargin)
    ...
    makeFigure;
    plotHeat(aveRespY,[xLabel ' (ave rotation speed)'],yLabel);
    ...
    makeFigure;
    hold on;
    plotXvsY(x,aveRespX,'left eye','deg/sec','error',semAveRespX);
    plotXvsY(x,predRespX,'left eye','deg/sec','lineStyle','--');
    hold off;
    confAxis('fTitle','predicted walking speed',varargin{:});
    
    makeFigure;
    hold on;
    plotXvsY(x,aveRespX','right eye','deg/sec','error',semAveRespX');
    plotXvsY(x,predRespX,'right eye','deg/sec','lineStyle','--');
    hold off;
    confAxis('fTitle','predicted walking speed',varargin{:});
