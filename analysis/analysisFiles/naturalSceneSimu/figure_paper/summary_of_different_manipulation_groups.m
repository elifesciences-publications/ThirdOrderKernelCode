function  [data,stim_info] = summary_of_different_manipulation_groups(synthetic_flag_bank, synthetic_type_bank, ns_num, x_tick_str, x_value)

is_symmetrize_flag = false;

% which_kernel_type = 'rc_match_up_iskew';
which_kernel_type = 'rc_match_up_row_mean_subtracted';
