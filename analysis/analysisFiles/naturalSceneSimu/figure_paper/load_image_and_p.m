...
if strcmp(which_mode, 'natural_scene')
    image_data = load('D:\Natural_Scene_Simu\image\statiche0\FWHM25\Image1.mat');
    I = image_data.I(row_id, :);
    med_data = [];
    p_i = [];
    
elseif strcmp(which_mode, 'syn_solu')
    solu_path = fullfile('D:\Natural_Scene_Simu\image',which_set,'FWHM25\Image1.mat');
    data = load(solu_path);
    ...
    image_path = fullfile('D:\Natural_Scene_Simu\image',which_set,'FWHM25\Image1.mat');
