...
void mexFunction(	
	...
	for(int tau3=0; tau3 < mxl; tau3++){
        for(int t=mxl-1; t<dataDims; t++){
            ...
            stored3a[t] = resp[t] * input4[t-tau3] / constNorm;
            stored4a[t] = resp[t] * input1[t-tau3] / constNorm;
        }
		for(int tau2=0; tau2 < mxl; tau2++){
            for(int t=mxl-1; t<dataDims; t++){
                ...
                stored4b[t] = stored4a[t] * input4[t-tau2];
            }
