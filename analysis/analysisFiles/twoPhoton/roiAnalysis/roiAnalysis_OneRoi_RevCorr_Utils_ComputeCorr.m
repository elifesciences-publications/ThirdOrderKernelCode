function result = roiAnalysis_OneRoi_RevCorr_Utils_ComputeCorr(respRepByTrial,predRespByTrial)
overall = corr(cell2mat(respRepByTrial),cell2mat(predRespByTrial));
