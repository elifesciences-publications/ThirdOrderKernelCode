function roi= roiAnalysis_OneRoi_KernelSelectoin_MultiD_2o(roi,varargin)
plotFlag = false;
...
noiseKernelPath = roi.stimInfo.secondNoisePath;
noiseKernelPath = [kernelFolder,noiseKernelPath];
load(noiseKernelPath);
noiseKernel = saveKernels.kernels;

[maxTauSquare,nMultiBars] = size(roi.filterInfo.secondKernel.dx1.Original);
