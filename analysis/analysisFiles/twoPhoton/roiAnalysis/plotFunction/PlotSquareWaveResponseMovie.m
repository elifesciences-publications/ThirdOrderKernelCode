function PlotSquareWaveResponseMovie(roi,resp,respLinear,stim)
[T,nMultiBars,~] = size(stim);



firstFilter = roi.filterInfoNew.firstKernelOriginal;
% barSelected = roi.filterInfo.firstBarSelected; % you have to shift to right for at least two.
% firstFilter(:,~barSelected) = 0; 
barCenter = roiAnalysis_FindFirstKernelCenter(roi,'method','barQuality');
