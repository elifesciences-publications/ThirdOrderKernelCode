%%
% choose the phase that you are interested in.
% 8 phase, there would not will more than 4 bars that you are interested
% in...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% it is really hard to get what phase to use...
phaseUse = 1:nBarUse;
