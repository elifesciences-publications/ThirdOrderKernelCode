...
for tt = 1:1:length(cov_mat_mean)
    ...
    for ii = 1:1:length(dx_plot_bank)
        for jj = 1:1:length(n_average_over_bars_bank)
            ...
            [dt_x_dx_plot_average_over_bar,~, ~, p_val] = ...
                ...
                'x_bank', x_bank_this_type, 'dx_plot',dx_plot_bank(ii),'n_average_over_bars',n_average_over_bars_bank(jj),'dt_bank',dt_bank ,'dt',dt, 'nMultiBars', nMultiBars);
            ...
            K2_Visualization_AverageOverBars_plot_dt_x_dx(dt_x_dx_plot_average_over_bar, ...
                'x_bank', x_bank_this_type, 'n_average_over_bars', n_average_over_bars_bank(jj), 'dx_plot',dx_plot_bank(ii),'dt_bank',dt_bank,'dt',dt, 'nMultiBars', nMultiBars)
            hold on
