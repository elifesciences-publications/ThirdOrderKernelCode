...
function [dt_x_dx_plot_average_over_bar, noise_mean_val, noise_std_val, p_val ]= K2_Visualization_AverageOverBars_Computation(cov_mat_glider_aligned, cov_mat_glider_aligned_noise, varargin)
...
dt_x_dx_plot_average_over_bar = K2_Visualization_AverageOverBars_Compute_dt_x_dx(cov_mat_glider_aligned, ...
    'x_bank', x_bank, 'n_average_over_bars', n_average_over_bars , 'dx_plot',dx_plot, 'dt_bank', dt_bank, 'dt', dt,'nMultiBars',nMultiBars);
