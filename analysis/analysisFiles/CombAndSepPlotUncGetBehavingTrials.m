 function analysis = CombAndSepPlotUncGetBehavingTrials(flyResp,epochs,params,stim,dataRate,dataType,interleaveEpoch,varargin)
...
%         end
    ...
    % run the algorithm for each fly
     for ff = 1:numFlies
        ...
        analysis.indFly{ff} = GetProcessedTrialsWalkingBeforeTrial(flyResp{ff},epochs{ff},params{ff},dataRate,dataType,varargin{:});
